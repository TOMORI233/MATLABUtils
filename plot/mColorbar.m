...
switch loc
    case "northoutside"
        cb = colorbar(otherParams{:}, "Position", [pos(1), pos0(2) + pos0(4) * 1.01, pos(3), pos0(4) * 0.025]);
    case "southoutside"
        cb = colorbar(otherParams{:}, "Position", [pos(1), pos0(2) - pos0(4) * 0.05, pos(3), pos0(4) * 0.025]);
    case "eastoutside"
        cb = colorbar(otherParams{:}, "Position", [pos0(1) + pos0(3) * 1.01, pos(2), pos0(3) * 0.025, pos(4)]);
    case "westoutside"
        cb = colorbar(otherParams{:}, "Position", [pos0(1) - pos0(3) * 0.05, pos(2), pos0(3) * 0.025, pos(4)]);
end
