...
% WARNING: Not recommended. Please use cwtAny instead.
warning("Function cwtMulti is NOT recommended. Please use cwtAny instead.");
% Apply cwt to multi-channel data and return spectrum within specified frequency range.
% It can be encoded by gpucoder for parallel computation. See demo_gpucoder.m
